...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tasks_task', 'assignee_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.TaskerUser']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Task.assignee'
        raise RuntimeError("Cannot reverse this migration. 'Task.assignee' and its values cannot be restored.")
    ...
    models = {
        ...
        u'tasks.task': {
            ...
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assigned_tasks'", 'null': 'True', 'to': u"orm['profiles.TaskerUser']"}),
