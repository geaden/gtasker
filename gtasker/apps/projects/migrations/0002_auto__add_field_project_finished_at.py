...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.finished_at'
        db.add_column(u'projects_project', 'finished_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.finished_at'
        db.delete_column(u'projects_project', 'finished_at')
